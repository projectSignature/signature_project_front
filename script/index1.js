...
function error_massege_japanese(){
  ...
  inputs[16].addEventListener('click', (e) => {
    plan = "Plan A"
    document.getElementById("select-plan-a").style.borderColor = '#5507FF';
    document.getElementById("select-plan-a").style.borderWidth = 'thick';
    document.getElementById("select-plan-b").style.borderColor = '#333333';
    document.getElementById("select-plan-b").style.borderWidth = 'thin';
    document.getElementById("select-plan-c").style.borderColor = '#333333';
    document.getElementById("select-plan-c").style.borderWidth = 'thin';
    document.getElementById("select-plan-d").style.borderColor = '#333333';
    document.getElementById("select-plan-d").style.borderWidth = 'thin';
    document.getElementById("select-plan-e").style.borderColor = '#333333';
    document.getElementById("select-plan-e").style.borderWidth = 'thin';
    document.getElementById("select-plan-f").style.borderColor = '#333333';
    document.getElementById("select-plan-f").style.borderWidth = 'thin';
  });
  var plan = '';
  inputs[17].addEventListener('click', (e) => {
    plan = "Plan B"
    document.getElementById("select-plan-b").style.borderColor = '#5507FF';
    document.getElementById("select-plan-b").style.borderWidth = 'thick';
    document.getElementById("select-plan-a").style.borderColor = '#333333';
  ...
  inputs[18].addEventListener('click', (e) => {
    plan = "Plan C"
    document.getElementById("select-plan-c").style.borderColor = '#5507FF';
  ...
  inputs[19].addEventListener('click', (e) => {
    plan = "Plan D"
    document.getElementById("select-plan-d").style.borderColor = '#5507FF';
  ...
  inputs[20].addEventListener('click', (e) => {
    plan = "Plan E"
    document.getElementById("select-plan-e").style.borderColor = '#5507FF';
  ...
  inputs[21].addEventListener('click', (e) => {
    plan = "Plan F"
    document.getElementById("select-plan-f").style.borderColor = '#5507FF';
